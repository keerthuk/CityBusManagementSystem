...
using CityBusManagement.BAL.Service;

namespace CityBusManagementSystemAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RouteDetailsDbContext>(options => options.UseSqlServer(connectionStr));
